...
lazy_static! {
    ...
    pub static ref AWESOME_5: Map<String, String> = map_to_owned! {
        "" => "",
        "time" => " \u{f017} ",
        "music" => " \u{f001} ",
        "music_play" => "  \u{f04b}  ",
        ...
        "net_vpn" => " \u{f023} ",
        "ping" => " \u{21ba} ",
        "backlight_empty" => " \u{f0eb} ",
        "backlight_partial1" => " \u{f0eb} ",
        "backlight_partial2" => " \u{f0eb} ",
        "backlight_partial3" => " \u{f0eb} ",
        "backlight_full" => " \u{f0eb} ",
        "weather_sun" => " \u{f185} ",
        "weather_snow" => " \u{f2dc} ",
        "weather_thunder" => " \u{f0e7} ",
        "weather_clouds" => " \u{f0c2} ",
...
pub fn get_icons(name: &str) -> Option<Map<String, String>> {
    match name {
        ...
        "awesome 5" => Some(AWESOME_5.clone()),
